...
{metropolis}
\setlength{\metropolis@titleseparator@linewidth}{1pt}%2pt title page
\setlength{\metropolis@progressonsectionpage@linewidth}{1pt}%2pt
\setlength{\metropolis@progressinheadfoot@linewidth}{.6pt}%1.6pt
...
\newlength{\my@bar@linewidth}
\newlength{\my@bar@padding}
\newlength{\my@bar@width}
\newlength{\my@bar@end}
\newlength{\my@bar@progress}
\setlength{\my@bar@linewidth}{\metropolis@progressinheadfoot@linewidth}
\setlength{\my@bar@padding}{\metropolis@frametitle@padding}
\setlength{\my@bar@width}{\paperwidth - 2\my@bar@padding}
\setlength{\my@bar@end}{\paperwidth - \my@bar@padding}
\setbeamertemplate{my progress bar}{
  \nointerlineskip
  \usebeamercolor{progress bar}
  \setlength{\my@bar@progress}{%
    \my@bar@padding + \my@bar@width * \ratio{\insertframenumber pt}{\inserttotalframenumber pt}%
  }%
  \begin{beamercolorbox}[wd=\paperwidth]{my progress bar}
    \begin{tikzpicture}
      \fill[normal text.bg] (0,0) rectangle (\paperwidth, \my@bar@linewidth);
      \fill[bg] (\my@bar@padding,0) rectangle (\my@bar@end, \my@bar@linewidth);
      \fill[fg] (\my@bar@padding,0) rectangle (\my@bar@progress, \my@bar@linewidth);
    \end{tikzpicture}%
  \end{beamercolorbox}
}
\addtobeamertemplate{frametitle}{}{%
  \usebeamertemplate*{my progress bar}
}
\addtobeamertemplate{frametitle}{}{%
  \insertMyLogo\hfill\insertframesubtitle%
